...
Newdf = pd.DataFrame({"Infant":Infant,"Female":Female,"Male":Male,"Length":list(df_noOutliers["Length"]),"Diam":list(df_noOutliers["Diam"]),"Height":list(df_noOutliers["Height"]),"Whole":list(df_noOutliers["Whole"]),"Shucked":list(df_noOutliers["Shucked"]),"Viscera":list(df_noOutliers["Viscera"]),"Shell":list(df_noOutliers["Shell"]),"Rings":list(df_noOutliers["Rings"])}, dtype ="d")
...
Newsclaeddf = pd.DataFrame({"Infant":Infant,"Female":Female,"Male":Male,"Length":list(scaled_df["Length"]),"Diam":list(scaled_df["Diam"]),"Height":list(scaled_df["Height"]),"Whole":list(scaled_df["Whole"]),"Shucked":list(scaled_df["Shucked"]),"Viscera":list(scaled_df["Viscera"]),"Shell":list(scaled_df["Shell"]),"Rings":list(scaled_df["Rings"])}, dtype ="d")
...
y1 = Newsclaeddf["Rings"].tolist() 
y=list()
for i in range(len(y1)):
    y = np.append(y,y1[i]+1.5)
